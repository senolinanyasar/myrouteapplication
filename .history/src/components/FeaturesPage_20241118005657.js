...
const features = [
    ...
    },
    {
        ...
        icon: <FaTruck />,
        shortDescription: 'Monitor deliveries and logistics in real-time.',
        detailedDescription:
            'Track your shipments and manage delivery schedules seamlessly to ensure customer satisfaction.',
    },
];
