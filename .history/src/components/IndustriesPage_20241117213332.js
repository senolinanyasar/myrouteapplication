...
const industries = [
    {
        ...
        description:
            'Designed for hot or cold field sales operations, manage your inventory, customers, and orders instantly via a mobile application.',
        features: [
            {
        ...
        testimonial: {
            ...
            button: 'Discover the My Route Advantage for Field Sales',
        },
    },
    {
        id: 'wholesale',
        ...
        testimonial: {
            ...
            button: 'Discover the My Route Advantage for Retail',
        },
    },
    {
        id: 'production',
        ...
        testimonial: {
            ...
            button: 'Discover the My Route Advantage for Production',
        },
    },
];
                ...
                <section key={industry.id} id={industry.id} className="industry-section">
                    ...
                    <div className="industry-testimonial">
                        ...
                        <div className="testimonial-image">
                            <img src={`images/${industry.id}.jpg`} alt={industry.testimonial.name} />
                        </div>
                    </div>
                </section>
            ))}
